...
import (
	...
	"github.com/AlexTLDR/ByteVault/internal/validator"
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// use the RenewToken() method on the current session to change the session ID when the
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Title, 100), "title", "Title limit of 100 characters exceeded")
